...
def main(logdir: str,
    ...
    # Load the default environment from the current config if the env_id is not
    # specified, else load the specified env_id.
    env_id = gin.query_parameter(
        "GymControlConfig.env_id") if env_id is None else env_id
