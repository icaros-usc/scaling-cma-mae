"""Provides MAEArchiveBase from CMA-MAE.

Adapted from
https://github.com/icaros-usc/cma_mae/blob/main/ribs/archives/_archive_base.py
"""
...
class MAEArchiveBase(ABC):  # pylint: disable = too-many-instance-attributes
    ...
    def add(self, solution, objective_value, behavior_values, metadata=None):
        ...
        was_inserted, already_occupied, old_threshold = self._add_numba(
            ...
            self._archive_learning_rate, self._threshold_floor,
